...
export default function TrazaAgrupada ({ trazasRecibidas }) {
  ...
  return (
    ...
    <Plot
      ...
      layout={{ width: 1200, height: 400, title: "Traza original: " + trazasRecibidas[0].titulo }}
    />

    <Plot
      data={trazasTendencias}
      layout={{ width: 1200, height: 400, title: "Tendencia: " + trazasRecibidas[0].titulo }}
    />

    <Plot
      data={trazasEstacionales}
      layout={{ width: 1200, height: 400, title: "Componente estacional: " + trazasRecibidas[0].titulo }}
    />

    <Plot
      data={trazasRuido}
      layout={{ width: 1200, height: 400, title: "Componente residual: " + trazasRecibidas[0].titulo }}
    />

    <Plot
      data={boxsPlots}
      layout={{ width: 1200, height: 400, title: "Dispersión: " + trazasRecibidas[0].titulo }}
    />

export default function SaveIcon({ ...props }) {
  return (
    ...
    >
      <switch>
        <g fill="#f3f5f6" className="color000000 svgShape">
          <path
            ...
            fill="#f3f5f6"
            bg-slate-600="color000000 svgShape"
          ></path>
          <path
            ...
            bg-slate-600="color000000 svgShape"
          ></path>
          <g fill="#f3f5f6" bg-slate-600="color000000 svgShape">
            <path
              d="M94.6,25.9L73.7,5c-1.6-1.6-3.8-2.5-6-2.5H58V20c0,1.8-1.5,3.3-3.3,3.3H27.3c-1.8,0-3.3-1.5-3.3-3.3V2.5H11.4

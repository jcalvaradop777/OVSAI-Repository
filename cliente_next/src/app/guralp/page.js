...
export default function RenderTrazaGuralp({element}) {
  ...
  return (
    <div className="flex">
      <SidebarTrazas onEnviarDatos={handleRecibirDatos} element={element} /> {/*esto es el lado izquierdo que obtiene los subfolders y los respectivos nombres de archivos */}

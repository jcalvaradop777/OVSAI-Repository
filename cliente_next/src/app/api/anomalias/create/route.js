...
export async function POST(req) {  // los datos del formulario de anomalias los enviamos mediante el parametro req (requery)
  ...
  try {
    ...
    await insertDataIntoTable("anomalias", names, values);  // tabla, campo, valor

    return NextResponse.json({
      success: true,
      message: "La anomalia se ha creado correctamente!",
    });
  } catch (error) {
    return NextResponse.json({
      success: false,
